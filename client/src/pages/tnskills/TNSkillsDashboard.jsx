    ...
    <AppLayout title="TNSKILLS State Monitoring Dashboard">
      <div className="space-y-7 pb-8">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-xs text-slate-500 mt-1 font-medium">
              State monitoring and certificate verification portal
            </p>
          </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 xl:grid-cols-5 gap-3.5">
          {/* 1. TOTAL COLLEGES */}
          <div className="bg-white rounded-2xl border border-slate-200/90 border-t-[3px] border-t-blue-600 p-4.5 shadow-xs hover:shadow-md hover:border-blue-300 transition-all duration-200 flex flex-col justify-between">
          ...
          {/* 2. TOTAL STUDENTS */}
          <div className="bg-white rounded-2xl border border-slate-200/90 border-t-[3px] border-t-emerald-600 p-4.5 shadow-xs hover:shadow-md hover:border-emerald-300 transition-all duration-200 flex flex-col justify-between">
            <div className="flex items-center justify-between">
              <span className="text-[11px] font-bold uppercase tracking-wider text-slate-500">
                Total Students
              </span>
          ...
          {/* 3. DEPARTMENTS */}
          <div className="bg-white rounded-2xl border border-slate-200/90 border-t-[3px] border-t-indigo-600 p-4.5 shadow-xs hover:shadow-md hover:border-indigo-300 transition-all duration-200 flex flex-col justify-between">
            <div className="flex items-center justify-between">
              <span className="text-[11px] font-bold uppercase tracking-wider text-slate-500">
                Departments
              </span>
          ...
          {/* 4. ISSUED CERTS */}
          <div className="bg-white rounded-2xl border border-slate-200/90 border-t-[3px] border-t-red-600 p-4.5 shadow-xs hover:shadow-md hover:border-red-300 transition-all duration-200 flex flex-col justify-between">
            <div className="flex items-center justify-between">
              <span className="text-[11px] font-bold uppercase tracking-wider text-slate-500">
                Issued Certs
              </span>
          ...
          {/* 5. PENDING CERTS */}
          <div className="bg-white rounded-2xl border border-slate-200/90 border-t-[3px] border-t-amber-500 p-4.5 shadow-xs hover:shadow-md hover:border-amber-300 transition-all duration-200 flex flex-col justify-between col-span-2 sm:col-span-1">
            <div className="flex items-center justify-between">
              <span className="text-[11px] font-bold uppercase tracking-wider text-slate-500">
                Pending Certs
              </span>
        ...
        {/* Colleges & Departments Section (Styled to match requested reference) */}
        <div className="space-y-4 pt-2">
          ...
          {/* VIEW 1: All Colleges Grid (Matching Screenshot 1) */}
          {!selectedCollege && (
              ...
              {colleges && colleges.length > 0 ? (
                colleges.map((col) => {
                  ...
                  return (
                    ...
                    >
                      {/* Left Icon: Soft red squircle with Building/Institution icon */}
          ...
          {/* VIEW 2: Departments in Selected College (Matching Screenshot 2) */}
          {selectedCollege && (
            <div className="space-y-4">
                ...
                {selectedCollege.departments && selectedCollege.departments.length > 0 ? (
                  selectedCollege.departments.map((dept) => {
                    ...
                    return (
                      ...
                      >
                        {/* Folder / Department Icon in soft blue/red squircle */}
              ...
              {/* Direct Link to View All Students in this College */}
